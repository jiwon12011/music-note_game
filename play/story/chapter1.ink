...
# popup: 누군가, 당신을 위한 곡을 쓰기 시작한 것 같아요.
...
# note: 프로듀서가 아니라 — 이안이, 처음으로 내 이름을 불렀다.
-> credits
...
# note: '우리 새내기'라던 그 별명이, 오늘은 고백처럼 들렸다.
-> credits
...
# note: 성씨로만 부르던 그가, 처음으로 — 가장 가깝게, 내 이름을 불렀다.
-> credits
...
# note: 말이 아니라 늘 음악이던 그가, 곡의 제목에 내 이름을 새겼다.
-> credits
...
# note: '우리 집 막내'가 아니라, 처음으로 내 이름 하나만을 불렀다.
-> credits
...
# bg: rooftop-dusk
# ending: solo
계절이 한 바퀴 돌았다. 6개월 동안, 분명 무언가를 느꼈다.
다만 — 그 마음에 이름을 붙이기가, 조금 늦었을 뿐이다.
옥상 난간에 기대 도시의 노을을 본다. 누구의 곡에도 끝까지 닿지 못한 채, 내 플레이리스트는 아직 비어 있다.
# note: 아직, 다시 재생할 수 있다면.
서두를 필요는 없다. 다음 계절엔, 조금 더 먼저 다가가 볼까.
-> credits
