...
난간에 기댄 윤재호. 헤드폰 사이로 희미한 멜로디가 새어 나온다.
...
# bg: office
# char: odaeun jacket center
매니지먼트에서 오다은의 역할이 커지며, 함께 일하는 시간이 줄었다.
# speaker: odaeun
…어차피 우린, 직장 동료잖아.
* [“동료, 그 이상이잖아요. 우리.”]
    ~ aff_odaeun += 15
    # speaker: odaeun
    …하여간. 그렇게 말하면, 나 또 착각하잖아.
* [“…그렇게 정리하고 싶어요?”]
    ~ aff_odaeun += 9
- -> odaeun_c3_2
...
# speaker: odaeun
…언제 이렇게 많이 찍었냐고? 모르게 찍었거든. 들키면, 좀 부끄러우니까.
* [“이거, 다 저예요.” 진지하게 본다]
    ~ aff_odaeun += 16
    # speaker: odaeun
...
# char: kael white center
# speaker: kael
이제 그만 신경 꺼. 네가 너무 가까우면 — 나, 이 곡 못 발표해.
* [“왜 그래요.” 붙잡는다]
    ~ aff_kael += 15
    # speaker: kael
    …너 진짜, 끝까지 안 놔주네. …고맙다, 그게.
* [“…알겠어요.” 물러선다]
    그의 눈빛이, 무대 조명보다 흔들렸다.
- -> kael_d3_3
...
# bg: stage
# char: kael stage center
신곡 발표 무대. KAEL이 처음으로, 고친 데 없는 가사 그대로를 불렀다.
...
# bg: living-night
# char: choijunhyeok knit center
최준혁이, 잠긴 방을 처음으로 열어줬다. 안은, 텅 비어 있었다.
# speaker: choijunhyeok
비워뒀어요. 다음 사람을 위해. …근데 이제, 그 다음 사람이 누군지 알 것 같아서.
* [“…무슨 뜻이에요?”]
    ~ aff_choijunhyeok += 14
    # speaker: choijunhyeok
