...
난간에 기댄 윤재호. 헤드폰 사이로 희미한 멜로디가 새어 나온다 — 한서아 데뷔곡의, 아직 완성되지 않은 트랙이라고 했다.
...
# speaker: jeongian
마감까지 펑크 한 번이면, 다 끝이에요. 그러니까 — 한 사람 몫은, 확실히 해줘요.
# speaker: jeongian
질문 있어요?
* [“바로 시작하겠습니다.” (담백하게)]
    ~ aff_jeongian += 8
...
* [“팬이에요! 잘 부탁드려요!” 들뜬다]
    ...
    # speaker: kael
    하아… 또 한 명 늘었네.
- 돌아서는 길, 그가 잠깐 사람 없는 쪽을 봤다. 무대 위와 전혀 다른, 어딘가 지친 옆얼굴이었다.
-> ch2_odaeun
